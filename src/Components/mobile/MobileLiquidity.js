              ...
              <h3 class="head-title">Market Cap</h3>
                ...
                <p className="pt-1 head__sum">{this.state.total_supply}</p>
                 ...
                 <h3 class="head-title">{this.state.symbol}/{this.convertPair(this.state.pair)} LP Holdings</h3>
                  <span> {this.state.balance_wbnb} {this.convertPair(this.state.pair)}  <a href="https://exchange.pancakeswap.finance/#/swap?outputCurrency=0x6AE97E66EeC23B4fDF77Cd4cA423ECfBD439c39e" target="_blank"  rel="noopener noreferrer">{this.state.exchange} </a></span> 
